        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/setting/designations/update/'. $designation['id']) }}" method="post" name="designation_edit_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('designation') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="designation" id="designation" class="form-control" value="{{ $designation['designation'] }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="designation_description" id="designation_description">{{ $designation['designation_description'] }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> {{ __('Update designation') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
