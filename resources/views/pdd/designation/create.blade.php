...
@include('layouts.includes.nav')
    <section class="content-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('designation.index') }}">Back</a></li>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="{{ route('designation.store') }}" method="post" name="designation_add_form">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <!-- Notification Box -->
                        <div class="col-md-12">
                            ...
                            @else
                                <p class="text-yellow">{{ __('Enter designation details. All field are required.') }} </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('designation') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="designation" id="designation" class="form-control" value="{{ old('designation') }}" placeholder="{{ __('Enter client name..') }}">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="designation_description">{{ __('Designation Description') }} <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="designation_description" id="designation_description" placeholder="{{ __('Enter client description..') }}">{{ old('designation_description') }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Add designation') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
