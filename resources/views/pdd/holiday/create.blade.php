      ...
      @include('layouts.includes.nav')
          ...
          <h1>
            {{ __('Holiday Lists') }}
             ...
             <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/holiday') }}">Back</a></li>
        ...
        <section class="content">
          ...
          <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="{{route('holiday.store')}}" method="post" name="holidays_add_form">
              {{ csrf_field() }}
              <div class="box-body">
                <div class="row">
                  <!-- Notification Box -->
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('holiday_date') ? ' has-error' : '' }}">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="date" name="holiday_date" class="form-control pull-right" id="datepicker">
