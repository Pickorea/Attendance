...
@include('layouts.includes.nav')
    <section class="content-header">
        ...
        <ul class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="true">Reports</a>
            ...
            <div class="box-header with-border">
                ...
                <div class="box-header with-border">
                        <div class="alert alert-info clearfix">
                            <a href="{{ route('leave.create') }}" class="alert-link"><button type="button" class="btn btn-primary btn-sm float-end">{{ __(' Add Leave') }}</button></a> 
                        </div>
                 </div>
            </div>
            <div class="box-body">
                        ...
                        @foreach($leave_applications as $leave_application)
                          <tr>
                            ...
                            @elseif($leave_application['publication_status'] == 1)
                              <a href="{{ route('leave_application.show', $leave_application['id']) }}" class="btn btn-success btn-xs btn-flat btn-block" data-toggle="tooltip" data-original-title="Accepted"><i class="icon fa fa-smile-o"> {{ __('Accepted') }}</i></a>
                            @else
                         ...
                         {{-- <td class="text-center">
                          <a href="{{ route('leave.show', $leave_application['id']) }}"><i class="icon fa fa-file-text"></i> {{ __('Details') }}</a>
                        </td>--}}
                    </tr>
                    @endforeach
