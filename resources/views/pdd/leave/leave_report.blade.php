    ...
    <section class="content-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Leave Application List</li>
            </ol>
        </nav>
    </section>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('pdf_reports') }}" class="btn btn-info btn-flat pull-right"><i class="fa fa-print"></i>{{ __('PDF') }} </a>
                </div>
                <br><br>
