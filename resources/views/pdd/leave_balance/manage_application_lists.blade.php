                          ...
                          <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ route('leave_application.show', $leave_application['id']) }}"><i class="icon fa fa-file-text"></i> {{ __('Details') }}</a></li>

                                    <li><a  href="{{ route('leave_application.approved',$leave_application['id']) }}"><i class="icon fa fa-file-text"></i> {{ __('Approved') }}</a></li>

                                    <li><a href="{{ route('leave_application.not_approved', $leave_application['id']) }}"><i class="icon fa fa-file-text"></i> {{ __('Not Approed') }}</a></li>
