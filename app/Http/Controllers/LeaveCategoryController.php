...
class LeaveCategoryController extends Controller
{
    ...
    public function index() {
        ...
        ->toArray();
        return view('pdd.leave_category.index', compact('leave_categories'));
    }
    ...
    public function create() {
        return view('pdd.leave_category.create');
    }
    ...
    public function store(Request $request) {
        ...
        if (!empty($inserted_id)) {
            return redirect()->route('leave_category.index')->with('message', 'Add successfully.');
        }
        return redirect()->route('leave_category.index')->with('exception', 'Operation failed !');
    }
    ...
    public function show($id) {
        ...
        ->toArray();
        return view('pdd.leave_category.show', compact('leave_category'));
    }
    ...
    public function edit($id) {
        ...
        return view('pdd.leave_category.edit', compact('leave_category'));
    }
