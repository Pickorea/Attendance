...
class DepartmentController extends Controller {
    ...
    public function index() {
        $departments = Department::all()
                ...
                ->toArray();
        return view('pdd.department.index', compact('departments'));
    }
    ...
    public function create() {
        return view('pdd.department.create');
    }
    ...
    public function store(Request $request) {
        ...
        if (!empty($inserted_id)) {
            return redirect()->route('department.index')->with('message', 'Add successfully.');
        }
        return redirect()->route('department.index')->with('exception', 'Operation failed !');
    }
    ...
    public function show($id) {
        ...
        $department = DB::table('departments')
                ...
                ->first();
                // dd($department);    
        // return view('pdd.department.show.department', compact('department'));
        return view('pdd.department.show', compact('department'));
    }
    ...
    public function edit($id) {
        ...
        return view('pdd.department.edit', compact('department'));
    }
