...
class DesignationController extends Controller {
    ...
    public function index() {
        ...
        return view('pdd.designation.index', compact('designations'));
    }
    ...
    public function create() {
        $departments = Department::all()
                ...
                ->toArray();
        return view('pdd.designation.create', compact('departments'));
    }
    ...
    public function store(Request $request) {
        ...
        if (!empty($inserted_id)) {
            return redirect()->route('designation.index')->with('message', 'Add successfully.');
        }
        return redirect('designation.index')->with('exception', 'Operation failed !');
    }
    ...
    public function show($id) {
        ...
        ->toArray();
        return view('pdd.designation.show', compact('designation'));
    }
    ...
    public function edit($id) {
        ...
        $departments = Department::all()
                ...
                ->where('deletion_status', 0)
                ->toArray();
        return view('pdd.designation.edit', compact('designation', 'departments'));
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('designations.index')->with('exception', 'Operation failed !');
    }
